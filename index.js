...
// Traigo los valores del Array de productos
 const allProductsReqArray = require("./api/allProducts.js")

//Ruta console.log todos los productos
const allProductsReq = require("./routes/products.js");
...
//Marcador modelo con Y
let includeY = null ;

console.log("Vehículo mas caro: ", sortedFilter[0].Marca +" "+ sortedFilter[0].Modelo);
console.log("Vehículo mas barato: ", sortedFilter[sortedFilter.length-1].Marca +" "+ sortedFilter[sortedFilter.length-1].Modelo)
console.log("Vehículos ordenados por precio de mayor a menor: ");
sortedFilter.forEach((e,index)=>{
...
if (includeY) {
  console.log(
    "Vehículo que contiene en el modelo la letra ‘Y’: " +
      sortedFilter[includeY].Marca +
      " " +
      sortedFilter[includeY].Modelo +
      " $" +
      sortedFilter[includeY].Precio
  );
}